...
import { FiCode, FiCpu, FiTrendingUp, FiUsers, FiBook, FiCoffee, FiChevronLeft, FiChevronRight, FiX } from 'react-icons/fi';
  ...
  return (
    <div className="bg-white pt-20">
      ...
      <section className="section-container bg-white">
        <motion.div {...fadeIn} className="text-center mb-12 sm:mb-16 px-4">
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Life at Tiny Prism Labs
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Get a glimpse of our collaborative work environment and team culture
          </p>
        </motion.div>
      ...
      {selectedImage !== null && (
        ...
        >
          ...
          <motion.img
            ...
            alt={`Team culture ${selectedImage + 1}`}
