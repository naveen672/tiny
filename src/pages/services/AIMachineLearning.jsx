...
import { FiEye, FiActivity, FiCpu, FiCheckCircle, FiDatabase, FiZap, FiTrendingUp, FiCloud, FiServer, FiChevronLeft, FiChevronRight, FiX } from 'react-icons/fi';
...
export default function AIMachineLearning() {
  ...
  const deploymentImages = [
    ...
    {
      src: 'Caught Red-Handed.png',
      title: 'Automated Defect Detection',
      description: 'Real-time quality control system detecting surface defects on manufacturing lines'
    },
    {
      src: 'The Dashboard View.png',
      title: 'Production Intelligence Dashboard',
      description: 'Comprehensive data visualization and operational analytics platform'
    },
    {
      src: 'Blueprint Grid.png',
      title: 'AI/ML Core Capabilities Overview',
      description: 'Complete suite of data analytics, engineering, and ML deployment solutions'
    },
    {
      src: 'Eyes Up (1).png',
      title: 'Video Analytics & Monitoring',
      description: 'Intelligent video processing for safety and operational insights'
    },
    {
      src: 'Journey Map.png',
      title: 'ML Pipeline Journey',
      description: 'End-to-end machine learning workflow and deployment process'
    },
    {
      src: 'Clean Slate.png',
      title: 'Data Processing & Preparation',
      description: 'Clean data pipelines for accurate model training and inference'
    }
  ];
      ...
      <section className="section-container bg-white">
        <motion.div {...fadeIn} className="text-center mb-12 sm:mb-16 px-4">
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            AI/ML Solutions in Action
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Real-world AI/ML deployments transforming industrial operations and data intelligence
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col items-center max-w-7xl w-full">
            <motion.img
              ...
              src={`/ai/${deploymentImages[selectedImage].src}`}
